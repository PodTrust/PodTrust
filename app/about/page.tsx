      ...
      <div className="max-w-5xl mx-auto bg-[#111827] border border-gray-800 rounded-3xl p-8 md:p-12 shadow-[0_0_80px_rgba(0,0,0,0.6)]">
        ...
        <div className="space-y-10 text-gray-400 text-sm leading-relaxed">
          ...
          <div>
            ...
            <p><span className="text-blue-400 font-medium">The Professional Solution:</span> PodTrust offers sellers verified proof of funds. Before a seller commits resources or ships inventory, they receive confirmation that the buyer's capital is secured in escrow. This eliminates the risk of "buyer’s remorse" or ghosting after delivery.</p>
          </div>
        ...
        <div className="mt-16 space-y-6">
          ...
          <div className="bg-[#0A0F1C] border border-gray-800 p-6 rounded-2xl">
            <h4 className="text-blue-400 font-semibold mb-2">🎯 Mission Statement</h4>
          ...
          <div className="bg-[#0A0F1C] border border-gray-800 p-6 rounded-2xl">
            <h4 className="text-purple-400 font-semibold mb-2">🌍 Vision Statement</h4>
            <p className="text-gray-400">
        ...
        {/* SUMMARY */}
        <div className="mt-12 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-gray-800 rounded-2xl">
